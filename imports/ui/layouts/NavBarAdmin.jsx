			...
			<nav className="navbar navbar-default navbar-static-top">
		      <div className="container">
		        <div className="navbar-header">
		          ...
		          <a className="navbar-brand" href="#">Online Shopping Admin</a>
		        </div>
		        <div id="navbar" className="navbar-collapse collapse">
		          <ul className="nav navbar-nav">
		            <li><a href="/AdminPage">Home</a></li>
		            <li><a href="/AboutPage">About</a></li>
		            <li><a href="ContacPage">Contact</a></li>
		          ...
		          <ul className="nav navbar-nav navbar-right">
		            ...
		            <li><a href="./InsertPage">Insert Product <span className="sr-only">(current)</span></a></li>
		            <li><a href="/AdminPage">Delete Product</a></li>
		          </ul>
		        </div>
		      </div>
		    </nav>
